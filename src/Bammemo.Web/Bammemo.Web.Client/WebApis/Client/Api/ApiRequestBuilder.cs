...
using Bammemo.Web.Client.WebApis.Client.Api.Analytics;
using Bammemo.Web.Client.WebApis.Client.Api.Files;
using Bammemo.Web.Client.WebApis.Client.Api.RedirectRules;
using Bammemo.Web.Client.WebApis.Client.Api.Settings;
using Bammemo.Web.Client.WebApis.Client.Api.SiteLinks;
...
namespace Bammemo.Web.Client.WebApis.Client.Api
{
    ...
    public partial class ApiRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Bammemo.Web.Client.WebApis.Client.Api.Analytics.AnalyticsRequestBuilder Analytics
        {
            get => new global::Bammemo.Web.Client.WebApis.Client.Api.Analytics.AnalyticsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The files property</summary>
        public global::Bammemo.Web.Client.WebApis.Client.Api.Files.FilesRequestBuilder Files
        {
            get => new global::Bammemo.Web.Client.WebApis.Client.Api.Files.FilesRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public global::Bammemo.Web.Client.WebApis.Client.Api.SiteLinks.SiteLinksRequestBuilder SiteLinks
        {
            get => new global::Bammemo.Web.Client.WebApis.Client.Api.SiteLinks.SiteLinksRequestBuilder(PathParameters, RequestAdapter);
        }
